...
def main() -> None:
  ...
  find_parser.add_argument("--version", "-v", help="Desired version (default: latest)")
  find_parser.add_argument("--from-version", "-f", help="Current cached version (for update check)")
  find_parser.add_argument("--cache-dir", "-c", type=Path, help="Cache directory")
  find_parser.add_argument("--save", "-s", action="store_true", help="Save to cache")
  find_parser.add_argument("--json", "-j", action="store_true", help="Output as JSON")
  find_parser.add_argument("--verbose", "-V", action="store_true", help="Verbose output")

  # cache command
  cache_parser = subparsers.add_parser("cache", help="Manage cache")
  cache_parser.add_argument("--clear", action="store_true", help="Clear cache")
  cache_parser.add_argument("--list", action="store_true", help="List cached packages")
  cache_parser.add_argument("--dir", action="store_true", help="Show cache directory")
