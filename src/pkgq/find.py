...
def get_pypi_info(package: str) -> dict[str, Any]:
...
def extract_github_url(pypi_info: dict[str, Any]) -> str | None:
...
def fetch_package_md_from_github(owner: str, repo: str, branch: str = "main") -> str | None:
